...
async function main() {
	console.log(
		"Running Phase 2 multi-iteration eval with environment variables...\n",
	);
	...
	console.log(
		"Result 1 - Pass Rate:",
		`${(result1.aggregateScores._overall.passRate * 100).toFixed(1)}%`,
	);
	...
	console.log(
		"Result 2 - Pass Rate:",
		`${(result2.aggregateScores._overall.passRate * 100).toFixed(1)}%`,
	);
	...
	console.log(
		"Result 3 - Pass Rate:",
		`${(result3.aggregateScores._overall.passRate * 100).toFixed(1)}%`,
	);
