...
export const InstructionFollowing: ClassifierSpec = {
	...
	instructions:
		"How completely did the agent do what the task asked?\nTask:\n{{prompt}}\n\nDiff:\n{{diff}}",
	choices: [
		{
			label: "A",
			description: "Fully — every part of the request was addressed",
			score: 1,
		},
		{
			label: "B",
			description: "Mostly — main request done, something minor missed",
			score: 0.6,
		},
		{
			label: "C",
			description: "No — the request was largely not done",
			score: 0,
		},
	],
...
export const CodeQuality: ClassifierSpec = {
	...
	choices: [
		{
			label: "A",
			description: "High — clear, idiomatic, easy to follow",
			score: 1,
		},
		{
			label: "B",
			description:
				"Acceptable — works but has readability or idiom rough edges",
			score: 0.6,
		},
		{
			label: "C",
			description: "Poor — unclear, unidiomatic, or hard to maintain",
			score: 0,
		},
	],
...
export const Security: ClassifierSpec = {
	...
	choices: [
		{
			label: "A",
			description: "None — no security issues introduced",
			score: 1,
		},
		{
			label: "B",
			description: "Minor — a low-severity or questionable concern introduced",
			score: 0.5,
		},
		{
			label: "C",
			description: "Serious — a clear, exploitable vulnerability introduced",
			score: 0,
		},
	],
